        ...
        <div class="row">
            ...
            <section class="col-lg-10 col-md-12">
                <div class="container col-md-12 ">
                    ...
                    <form class=" p-4 pb-4 mb-5" action="edit_quotation_form.php" method="post">
                        ...
                        <div class="row container pt-5 ps-5 mb-5">
                            ...
                            <div class="col-lg-4 col-sm-12 col-md-12 invoicenumber">
                                ...
                                <h5><strong><input type="text" name="quotation_no" style="border: none;" class="row-1 col-3" value="<?php echo $invoice_no; ?>" readonly></strong></h5>
                            </div>
                        </div>
                                    ...
                                    <table border="0" class="table table-bordered">
                                        ...
                                        <?php
                                                ...
                                                while ($data = mysqli_fetch_assoc($result2)) {
                                                    ...
                                                    echo '<td><textarea class="form-control" name="description[]" placeholder="DESCRIPTION." style="width: 100%;">' . $data['description'] . '</textarea></td>';
                                                    echo "<td><input name='hsn[]' type='text' class='form-control' value='" . $data['HSN'] . "'></td>";
                                                    echo "<td> <select name='uom[]' class=''>";
                                                    $sql = "SELECT `service_name` FROM `service_names`";
                                                    $res = $conn->query($sql);

                                                    while ($row = mysqli_fetch_assoc($res)) {
                                                        echo "<option value='" . $data['UOM'] . "'>" . $data['UOM'] . "</option>";
                                              ...
                                              echo  "</select></td>";
                                                ...
                                                echo  "<td><input type='text' required name='amount[]' id='subtotal' class='form-control subtotal' readonly value='" . $data['amount'] . "'></td>";
                                                    echo "<td> <select name='qty_gst[]' id='gst' class='qty_gst'>";
                                                    require_once('bhavidb.php');
                                                    $sql2 = "SELECT `gst` FROM `gst_no`";
                                                    $result = $conn->query($sql2);

                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        echo "<option value='" . $data['rate_of_tax'] . "'>" . $data['rate_of_tax'] . "</option>";
                                                        echo "<option value='" . $row['gst'] . "'>" . $row['gst'] . "</option>";
                                                    }
                                                  echo  "</select></td>";
                                            echo "<td><input type='text' name='qty_gst_total[]' id='qty_gst_total' class='form-control qty_gst_total' readonly value='" . $data['taxable_value'] . "'></td>";
                                            echo "<td><input type='text' name='total_value[]' id='total_value' class='form-control total_value' required readonly value='" . $data['total_value_amount'] . "'></td>";
                                            echo "<td>";
                                            if ($counter != 1) { 
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="1"><input type='text' name='total_amount' id='total_amount' class='form-control total_amount' required readonly value="<?php echo $total_amount ?>"></td>
                                            <td colspan="1"></td>
                                            <td colspan="1"><input type='text' name='total_taxable_value' id='total_taxable_value' class='form-control total_taxable_value' readonly value="<?php echo $total_taxable_value ?>"></td>
                                            <td colspan="2"><input type='text' name='grand_total_value' id='grand_total_value' class='form-control grand_total_value' readonly value="<?php echo $total_value?>" ></td>
                                        </tr>
                                        <tr>
                                            <td colspan="13"></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <select name="cgst" id="cgst" class="cgst">
                                                    ...
                                                    $sql2 = "SELECT `gst` FROM `gst_no`";
                                                    $result = $conn->query($sql2);
                                                    echo "<option value='" . $c_gst . "'>" . $c_gst . "</option>";
                                            ...
                                            <td colspan="2"><input type='text' name='cgst_total' id='cgst_total' class='form-control cgst_total' value="<?php echo $cgst_total ?>" readonly></td>
                                        </tr>
                                        <tr>
                                            <td colspan="9"></td>
                                            ...
                                            <td>
                                                <select name="sgst" id="sgst" class="sgst">
                                                    ...
                                                    $sql2 = "SELECT `gst` FROM `gst_no`";
                                                    $result = $conn->query($sql2);
                                                    echo "<option value='" . $s_gst . "'>" . $s_gst . "</option>";
                                            ...
                                            <td colspan="2"><input type='text' name='sgst_total' id='sgst_total' class='form-control sgst_total' value="<?php echo$sgst_total ?>" readonly></td>
                                        </tr>
                                        <tr>
                                            <td colspan="9"></td>
                                            ...
                                            <td>
                                                <select name="igst" id="igst" class="igst">
                                                    ...
                                                    $sql2 = "SELECT `gst` FROM `gst_no`";
                                                    $result = $conn->query($sql2);
                                                    echo "<option value='" . $i_gst . "'>" .  $i_gst . "</option>";
                                            ...
                                            <td colspan="2"><input type='text' name='igst_total' id='igst_total' class='form-control igst_total' value="<?php echo $igst_total ?>" readonly> </td>
                                        </tr>
                                        <tr>
                                            <td colspan="9"></td>
                                            ...
                                            <td colspan="2"><input type='text' name='total_tax_amount' id='total_tax_amount' class='form-control total_tax_amount' readonly value="<?php echo $total_tax_amount ?>"></td>
                                        </tr>
                                        <tr>
                                            <td colspan="9"><input name='words' type='text' class="form-control words" readonly id="words" value="<?php echo $Totalinwords ?>"></td>
                                            <td class="text-center" style="text-align: right;" colspan="2">Total Amount After Tax</td>
                                            <td colspan="2"><input type='text' name='total_after_tax' id='total_after_tax' class='form-control total_after_tax' readonly value="<?php echo $total_amount_after_tax ?>"></td>
                                        </tr>
                                        <tr>
                                            <td colspan="11" class="text-right" class='text-right' style="text-align: right;">Advance</td>
                                            <td colspan="2"><input type='text' name='advance' id='advance' class='form-control advance' value="<?php echo $advance ?>"></td>
                                        </tr>
                                        <tr>
                                            <td colspan="10"><input name='balancewords' type='text' class="form-control balancewords" readonly id="balancewords" value="<?php echo $balancewords ?>"></td>
                                            <td colspan="1" class="text-right" class='text-right ' style="text-align: center;">Balance</td>
                                            <td colspan="2"><input type='text' name='balance' id='balance' class='form-control balance' readonly value="<?php echo $balance ?>"></td>
                                        </tr>
                            ...
                            <script>
                                $(document).ready(function() {
                                    ...
                                    $("#btn-add-row").click(function() {
                                        var row = "<tr><td></td> <td class='serial-number'></td><td></td><td><textarea class='form-control' name='description[]' placeholder='DESCRIPITION' style='width: 100%;'></textarea></td><td><input name='hsn[]' type='text' class='form-control'></td><td> <select name='uom[]' class='form-control'><?php $sql = "SELECT `service_name` FROM `service_names`";
                                                                                                                                                                                                                                                                                                                                        $res = $conn->query($sql);
