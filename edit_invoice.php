    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <section class="col-lg-10 col-md-12">
                ...
                <form class=" p-4 pb-4 mb-5" action="edit_invoice_form.php" method="post">
                    ...
                    <div class="row container pt-5 ps-5 mb-5">
                        ...
                        <div class="col-lg-4 col-sm-12 col-md-12 invoicenumber">
                            ...
                            <h5><strong><input type="text" name="invoice_no" style="border: none;" class="row-1 col-3" value="<?php echo $invoice_no; ?>" readonly></strong></h5>
                        </div>
                    </div>
                        ...
                        <script>
                            $(document).ready(function() {
                                ...
                                $("#btn-add-row").click(function() {
                                    var row = "<tr><td></td> <td class='serial-number'></td><td></td><td><textarea class='form-control' name='description[]' placeholder='DESCRIPITION' style='width: 100%;'></textarea></td><td><input type='text' class='form-control' name='hsn[]'></td><td> <select name='uom[]' class='form-control'><?php $sql = "SELECT `service_name` FROM `service_names`";
                                                                                                                                                                                                                                                                                                                                    $res = $conn->query($sql);
