...
<head>
    ...
    <title>CUTOMIZED EDITS|M E</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class=" navbar-collapse  " id="navbarNav">
                            <ul class="navbar-nav " style="margin-left: 10%; text-align: center;">
                                <li class=" ">
                                    <a href="#" class="nav-link  nav-links active-link mt-4" id="add_customer_details"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
<script>
     document.addEventListener('DOMContentLoaded', function() {
               ...
               var addCustomerButton = document.getElementById('add_customer_details');
