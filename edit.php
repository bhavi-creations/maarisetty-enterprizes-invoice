            ...
            <section class="col-lg-10">
                <div class="container ">
                    ...
                    <form class="  p-4 pb-4 mb-5" action="editform.php" method="post">
                        <img src="img/me_log.jpg" alt="" class="mx-auto d-block" height="30%" width="30%">
                        ...
                        <div class="row container pt-5 ps-5 mb-5">
                            ...
                            <div class="col-lg-4 col-sm-12 col-md-12 invoicenumber">
                                ...
                                <h4><strong>  <input type="text" name="invoice_no" style="border: none;" class="row-1 col-3" value="<?php echo $invoice_no; ?>" readonly></strong></h4>
                            </div>
                        </div>
                                        ...
                                        <tbody id="product_tbody">
                                            <tr>
                                                ...
                                                while ($data = mysqli_fetch_assoc($result2)) {
                                                    ...
                                                    echo "<td class= 'text-center'>" . $data['HSN'] . "</td>";
                                                    echo "<td class= 'text-center'>" . $data['UOM'] . "</td>";
                                                    echo "<td class= 'text-center'>" . $data['Qty'] . "</td>";
                                                    echo "<td class= 'text-center'>" . $data['price'] . "</td>";
                                                    echo "<td class= 'text-center'>" . $data['amount'] . "</td>";
                                                    echo "<td class= 'text-center'>" . $data['rate_of_tax'] . "</td>";
                                                    echo "<td class= 'text-center'>" . $data['taxable_value'] . "</td>";
                                                    echo "<td class= 'text-center'>" . $data['total_value_amount'] . "</td>";
                                                    echo "</tr>";
                                                    $counter++;
                                                }
                                                ?>
                                         ...
                                         <tfoot>
                                            <tr>
                                                ...
                                                <td colspan="1" style="text-align: center;"><?php echo $total_amount ?></td>
                                                <td colspan="1"></td>
                                                <td colspan="1" style="text-align: center;"><?php echo $total_taxable_value ?></td>
                                                <td colspan="1" style="text-align: center;"><?php echo $total_value ?></td>
                                            </tr>
                                            <tr>
                                                <td colspan="10"></td>
                                            </tr>
                                            <tr>
                                                <td colspan="7"></td>
                                                <td colspan='1' style="text-align: center;">CGST%</td>
                                                <td colspan="1" style="text-align: center;"><?php echo $c_gst ?></td>
                                                <td style="text-align: center;"><?php echo $cgst_total ?></td>
                                            </tr>
                                            <tr>
                                                <td colspan="7"></td>
                                                <td colspan='1' class='text-right' style="text-align: center;">SGST%</td>
                                                <td style="text-align: center;"><?php echo $s_gst ?></td>
                                                <td colspan="1" style="text-align: center;"><?php echo $sgst_total ?></td>
                                            </tr>
                                            <tr>
                                                <td colspan="7"></td>
                                                <td colspan='1' style="text-align: center;">IGST%</td>
                                                <td style="text-align: center;"><?php echo $i_gst ?></td>
                                                <td colspan="1" style="text-align: center;"><?php echo $igst_total ?></td>
                                            </tr>
                                            <tr>
                                                <td colspan="7"></td>
                                                <td colspan='2'style="text-align: center;">Total Tax Amount</td>
                                                <td colspan="1" style="text-align: center;"><?php echo $total_tax_amount ?></td>
                                            </tr>
                                            <tr>
                                                <td colspan="7"><?php echo $Totalinwords ?></td>
                                                <td class="text-center" style="text-align: center;" colspan="2">Total Amount After Tax</td>
                                                <td colspan="1" ><input style="text-align: center;" type='text' name='Final_total' id='final_total' class='form-control final_total' value="<?php echo $total_amount_after_tax ?>" readonly></td>
                                            </tr>
                                            <tr>
                                                <td colspan="9" class="text-right" style="text-align: right;">Pre Advance</td>
                                                <td colspan="1"><input style="text-align: center;" type='text' name='advance' id='advance' class='form-control advance' value="<?php echo $advance; ?>" readonly></td>
                                            </tr>
                                            <tr>
                                                <td colspan="9" class="text-right" style="text-align: right;">New Advance</td>
                                                <td colspan="" class="text-center"><input style="text-align: center;" type='text' name='newadvance' id='newadvance' class='form-control newadvance'></td>    
                                            </tr>                                        
                                            <tr>
                                                <td colspan="8"><input name='balancewords' type='text' class="form-control balancewords" readonly id="balancewords" value="<?php echo $balancewords; ?>"></td>
                                                <td  colspan="1" style="text-align: center;">Balance</td>
                                                <td colspan="2" class="text-center"><input style="text-align: center;"  type='text' name='balance' id='balance' class='form-control balance' value="<?php echo $balance; ?>" readonly></td>
