    ...
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class=" navbar-collapse  " id="navbarNav">
                            <ul class="navbar-nav " style="margin-left: 10%; text-align: center;">
                                <li class=" ">
                                    <a href="#" class="nav-link  nav-links active-link mt-3 " id="add_customer"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <section class="col-lg-10">
                        ...
                        <table class="table table-bordered viewinvoicetable">
                            ...
                            <tbody id="product_tbody viewinvoicetable">
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td>" . $row['total_amount_after_tax'] . "</td>";
                        ...
                        <table class="table table-bordered viewinvoicetable">
                            ...
                            <tbody id="product_tbody viewinvoicetable">
                                ...
                                while ($col = $result2->fetch_assoc()) {
                                    ...
                                    echo "<td>" . $col['total_amount_after_tax'] . "</td>";
                ...
                // Fetch paid invoices
                $sql = "SELECT MONTH(Invoice_date) AS month, SUM(total_amount_after_tax) AS totalAmount
        FROM invoice
        WHERE `status` = 'paid'
