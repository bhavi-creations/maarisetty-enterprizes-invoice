...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['convert_id'])) {
   ...
   // Fetch data from the quservice table
    ...
    $insert_sql = "INSERT INTO `invoice` (Invoice_no, Invoice_date, Company_name, Cname, Cphone, Caddress, Cmail, Cgst, total_amount, total_taxable_value, total_value, c_gst, s_gst, i_gst, cgst_total , sgst_total, igst_total, total_tax_amount, total_amount_after_tax, Totalinwords, Terms, Note, advance, balance, balancewords, status) 
                    VALUES ('$quotation_no', '" . $row_quotation['quotation_date'] . "', '" . $row_quotation['Company_name'] . "', '" . $row_quotation['Cname'] . "', '" . $row_quotation['Cphone'] . "', '" . $row_quotation['Caddress'] . "', '" . $row_quotation['Cmail'] . "','" . $row_quotation['Cgst'] . "', '" . floatval($row_quotation['total_amount']) . "', '" . floatval($row_quotation['total_taxable_value']) . "', '" . floatval($row_quotation['total_value']) . "', '" . $row_quotation['c_gst'] . "', '" . $row_quotation['s_gst'] . "', '" . $row_quotation['i_gst'] . "', '" . floatval($row_quotation['cgst_total']) . "', '" . floatval($row_quotation['sgst_total']) . "', '" . floatval($row_quotation['igst_total']) . "', '" . floatval($row_quotation['total_tax_amount']) . "', '" . floatval($row_quotation['total_amount_after_tax']) . "', '" . $row_quotation['Totalinwords'] . "','" . $row_quotation['Terms'] . "','" . $row_quotation['Note'] . "','" . floatval($row_quotation['advance']) . "','" . floatval($row_quotation['balance']) . "','" . $row_quotation['balancewords'] . "', ' ')";
