...
<tr >
<td colspan="2" style="text-align: center;">TAX INVOICE</td></tr>
<tr>
<td width="40%" style="text-align: left; font-size: 15px;">BUYER DETAILS</td>
<td style="text-align: ; font-size: 15px;">INVOICE DETAILS</td>
</tr>
<tr>
...
while ($data = mysqli_fetch_assoc($result2)) {
	$html .= '
		<tr >
			...
			<td class="table-content" align="center">' . $data['HSN'] . '</td>
